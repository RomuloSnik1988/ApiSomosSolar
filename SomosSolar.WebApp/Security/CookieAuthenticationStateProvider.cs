...
using SomoSSolar.Core.Models.Account;
using System.Net.Http.Json;
using System.Security.Claims;

namespace SomosSolar.WebApp.Security
{
    public class CookieAuthenticationStateProvider(IHttpClientFactory clienteFactory)
      : AuthenticationStateProvider, ICookieAuthenticationStateProvider
    {
        private bool _isAuthenticated = false;
        private readonly HttpClient _client = clienteFactory.CreateClient(Configuration.HttpClientName);
